...
- `zig build -Darch=x86_64 check` — the x86_64 port's gate: 20 drills
  (all but the aarch64 hypervisor's) on OVMF + Limine with VT-d under
  KVM, ~3 min. Run it too when kernel/, user/, shared/ or the runner
