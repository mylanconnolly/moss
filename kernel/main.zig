...
export fn kmain(boot_arg: u64) noreturn {
    ...
    if (build_options.locale_test) {
        _ = sched.spawn("boot-watch", localeTestWorker, 0, .{}) catch |e| {
            std.debug.panic("spawn boot-watch: {t}", .{e});
        };
    }
    if (build_options.localeupd_test) {
        _ = sched.spawn("boot-watch", localeupdTestWorker, 0, .{}) catch |e| {
            std.debug.panic("spawn boot-watch: {t}", .{e});
        };
    }
    ...
    if (build_options.dock_test) {
        _ = sched.spawn("boot-watch", dockTestWorker, 0, .{}) catch |e| {
            std.debug.panic("spawn boot-watch: {t}", .{e});
        };
    }
    ...
    if (build_options.explorer_test) {
        _ = sched.spawn("boot-watch", explorerTestWorker, 0, .{}) catch |e| {
            std.debug.panic("spawn boot-watch: {t}", .{e});
        };
    }
    ...
    if (build_options.editor_test) {
        _ = sched.spawn("boot-watch", editorTestWorker, 0, .{}) catch |e| {
            std.debug.panic("spawn boot-watch: {t}", .{e});
        };
    }
...
fn localeTestWorker(_: u64) void {
    systemDrill("locale");
}
...
fn topbarTestWorker(_: u64) void {
    systemDrill("topbar");
}
...
fn editorTestWorker(_: u64) void {
    systemDrill("editor");
}
