...
const max_shms = 64;
pub const shm_max_pages = 384; // 1.5M: a program stage — msh, with every command module and the mshl interpreter, crossed 1M; the blk data window needs 8 x 32K slots
