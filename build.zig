...
pub fn build(b: *std.Build) void {
    ...
    for ([_][]const u8{
        ...
        "conf/sessiongui/console.msh",      "conf/units/browse-client.msh",
        ...
        "scripts/gui-login.msh",            "conf/units/gui-tlogin.msh",
        "scripts/gui-tlogin.msh",           "conf/units/gui-session.msh",
        "scripts/gui-session.msh",          "conf/units/usersvc-gui.msh",
        "conf/units/login-console.msh",     "scripts/lconsole.msh",
        "conf/units/gui-isession.msh",      "conf/units/gui-boom.msh",
        "scripts/gui-boom.msh",             "conf/units/fontsvc.msh",
        "conf/font.msh",                    "conf/units/fontsvc-fs.msh",
        "conf/units/fontcli.msh",           "conf/units/ptr-drill.msh",
        "conf/units/ptr.msh",               "conf/units/compositor-ptr.msh",
        "conf/units/ptrcli.msh",            "conf/units/gui-click.msh",
        ...
        "conf/sessiongui/explorer.msh",     "conf/sessiongui/sterm.msh",
        "conf/sessiongui/terminal.msh",     "conf/sessiongui/clipsvc.msh",
        "scripts/demo.msh",                 "scripts/gui-shell.msh",
        "conf/skel/font.msh",               "conf/sessiongui/medit.msh",
        "conf/units/gui-medit.msh",         "conf/sessiongui/filepicker.msh",
        "conf/units/editor-filepicker.msh", "conf/sessiongui/chooser.msh",
        "conf/units/chooser.msh",
    }) |f| {
