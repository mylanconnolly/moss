...
pub fn build(b: *std.Build) void {
    ...
    // aarch64, the ELF (debug info stripped) on x86_64.
    {
        ...
        for ([_][]const u8{
            ...
            "blk_test",   "gpu_test",    "term_test",    "input_test",   "seat_test",    "gseat_test",   "comp_test",    "focus_test",   "fs_test",      "net_test",     "fabric_test",
