...
pub fn build(b: *std.Build) void {
    ...
    // aarch64, the ELF (debug info stripped) on x86_64.
    {
        ...
        for ([_][]const u8{
            ...
            "trust_test",  "readers_test", "gui_test",     "fs_test",
            "net_test",    "fabric_test",  "shell_test",   "rng_test",
            "smmu_test",   "vm_test",      "guest_test",   "vmnode_test",
            "pan_test",    "cpu_test",     "users_test",   "login_test",
            "flogin_test", "dot_test",
